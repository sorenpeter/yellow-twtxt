...
class Slimdown {
	public static $rules = array (
		...
		// grid hack (by sp@darch.dk):
		'/!\[(grid)\]\((.*?)\)/' => '<p class="grid"><a class="image" href="\2" target="_top"><img src="\2" alt="\1" loading="lazy"></a>',
		'/!\[(.*?)\]\((.*?)\)/' => '<a class="image" href="\2" target="_top"><img src="\2" alt="\1" loading="lazy"></a>', 
		//'/!\[(.*?)\]\((.*?)\)/' => '[image \2]', 
